  ...
  return (
    <>
      <div className={styles.container}>
        <img src={product.img} alt="product" className={styles.product_image} onClick={handleOpen} />
        <>
        <div className={styles.product_img_overlay}>
          <div className={styles.product_content}>
          <Button variant="purple" sx={{width:"auto", opacity:"1"}}>Add to import list</Button>
          </div>
        </div>
        </>
      </div>
